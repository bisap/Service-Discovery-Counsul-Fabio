...
namespace DataService
{
    public static class ApplicationBuilderExtensions
    {
        public static IApplicationBuilder UseConsulRegisterService(this IApplicationBuilder app)
        {
            ...
            var fabioOptions = app.ApplicationServices.GetRequiredService<IOptions<FabioOptions>>() ?? throw new ArgumentException("Missing dependency", nameof(IOptions<FabioOptions>));
            ...
            foreach (var address in addresses)
            {
                ...
                if (!string.IsNullOrEmpty(serviceOptions.Value.HealthCheckTemplate))
                {
                    ...
                    //var scheme = addresss.StartsWith("http", StringComparison.InvariantCultureIgnoreCase)
                    //  ? string.Empty
                    //  : "http://";
                    ...
                    serviceChecks.Add(new AgentServiceCheck()
                    {
                        ...
                        Interval = TimeSpan.FromSeconds(3000),
                ...
                var registration = new AgentServiceRegistration()
                {
                    ...
                    Port = address.Port,
                    Tags =  GetFabioTags(serviceOptions.Value.ServiceName, "dataservice") 
                };
